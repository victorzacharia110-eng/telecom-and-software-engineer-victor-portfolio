  ...
  <div class="projects-page">
    <div class="page-header">
      <div class="page-header-inner">
        ...
        <p class="page-sub">A curated collection of enterprise solutions we've crafted with precision.</p>
...
<style scoped>
.projects-page { min-height: 100vh; position: relative; z-index: 1; }
.page-header {
